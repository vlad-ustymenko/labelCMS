...
import st from "./Achievements.module.css";
    ...
    >
      <Container>
        <h2 className={`${st.title}`}>
          <AnimateText stagger={0.1} duration={0.4} highlight="досягнення">
            Наші досягнення
          </AnimateText>
        </h2>
        ...
        <div className={st.grid}>
          ...
          <div className={st.content}>
            <AnimateText stagger={0.1} duration={0.4} className={st.text}>
              Наша місія — вкласти в кожен сантиметр вашого простору ергономіку,
              стиль і функціональність. Кожна деталь має значення:
              Індивідуальність | Якість | Функціональність
            </AnimateText>
